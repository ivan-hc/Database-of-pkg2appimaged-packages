...
DEPENDENCES="libpulse pipewire-jack pulseaudio reapack" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
...
_remove_more_bloatwares() {
	...
	lib_remove="gcc libgphobos python"
	for r in $lib_remove; do
		rm -Rf ./"$APP".AppDir/.junest/usr/lib/"$r"*
	done
	share_remove="gcc gir i18n zoneinfo"
