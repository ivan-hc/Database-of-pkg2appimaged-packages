...
rm -R -f ./"$APP"/"$APP".AppDir/usr/share/doc
rm -R -f ./"$APP"/"$APP".AppDir/usr/share/metainfo/*
rm -R -f ./"$APP"/"$APP".AppDir/usr/share/perl
rm -R -f ./"$APP"/"$APP".AppDir/usr/lib/*/perl
