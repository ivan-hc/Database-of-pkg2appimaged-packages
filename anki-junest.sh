...
BINSAVED="gio"
SHARESAVED="applications xml mime qt6 X11 wayland"
LIBSAVED="alsa jack pipewire pulse wayland gdk-pixbuf libproxy libnghttp libidn libssh libpsl libunistring libQt libsharpyuv libabsl libsodium libpgm libsoxr libjxl libhwy \
...
SDL EGL libGL gambas wayland libva python libnss libsensors gio libGL libXGL urllib3 QtWebEngineProcess vulkan Vulkan"
