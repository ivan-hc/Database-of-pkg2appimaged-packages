...
LIBSAVED="gdk-pixbuf spell $lib_browser_launcher"
...
bind_dirs=" /media /mnt /opt /run/media /usr/lib/locale /usr/share/fonts /usr/share/hunspell /usr/share/myspell /usr/share/themes /var $bind_nvidia_data_dirs"
if [ "$PROOT_ON" = 1 ]; then
...
_enable_mountpoints_for_the_inbuilt_bubblewrap() {
	...
	share_dirs="egl fonts glvnd hunspell myspell nvidia themes vulkan"
