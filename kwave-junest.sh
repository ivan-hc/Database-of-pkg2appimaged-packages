...
QTVER=$(curl -Ls https://archlinux.org/packages/extra/x86_64/kwave/ | tr '"><' '\n' | grep "^qt.*base$" | head -1)
[ "$QTVER" = qt5-base ] && kvantumver="kvantum-qt5 qt5ct" || kvantumver="kvantum qt6ct"
DEPENDENCES="ca-certificates $kvantumver opus"
...
mv ./*AppImage ./Kwave_Sound_Editor-"$VERSION"-archimage3.4.4-2-x86_64.AppImage
