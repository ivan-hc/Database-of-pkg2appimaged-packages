...
DEPENDENCES="fdkaac flac lame mac musepack-tools opus-tools vorbis-tools wavpack"
...
LIBSAVED="pk p11 libatk- gdk-pixbuf librsvg $lib_browser_launcher" # Enter here keywords or file/directory names to save in /usr/lib
