...
DEPENDENCES="cdparanoia fdkaac flac lame mac musepack-tools opus-tools vorbis-tools wavpack " #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
