...
LIBSAVED="pk p11 alsa jack pipewire pulse libkmod libv4l libusb Multimedia libuvc libgstapp libavcodec libavformat libvlc libSDL libswscale libgstvideo \
	libgstaudio libgstpbutils libXrandr libavdevice libportaudio libGLX $lib_browser_launcher" # Enter here keywords or file/directory names to save in /usr/lib
