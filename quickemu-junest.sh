...
DEPENDENCES="gawk qemu-full" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCES ARE NEEDED
...
if test -f ./*.desktop; then
	...
	StartupNotify=true
	HEREDOC
	curl -Lo quickemu.png https://raw.githubusercontent.com/quickemu-project/quickemu/master/.github/logo.png
else
...
ARCH=x86_64 ./appimagetool --comp zstd --mksquashfs-opt -Xcompression-level --mksquashfs-opt 20 \
	-u "$UPINFO" \
	./"$APP".AppDir "$APPNAME"_"$VERSION"-archimage4.8-x86_64.AppImage
