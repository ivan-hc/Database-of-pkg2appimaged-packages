...
DEPENDENCES="alsa-lib karchive kcoreaddons kcrash kio kjobwidgets kwallet libpulse libxcb nss nss-mdns openssl pipewire purpose pyside6 qt6-base qt6-declarative qt6-webchannel qt6-webengine" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
...
LIBSAVED="falkon libogg.so libvorbisenc.so libFLAC.so libmpg123.so libmp3lame.so libGL libsoftokn vulkan Vulkan"
...
_JUNEST_CMD -- QTWEBENGINE_CHROMIUM_FLAGS=--disable-gpu $EXEC "$@"
